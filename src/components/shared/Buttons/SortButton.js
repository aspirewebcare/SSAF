...
const SortButton = ({ sort, arr, data, sortChange }) => {
  ...
  return (
    <div className=" relative">
      <div
        ref={button}
        className={`w-[120px] sm:w-[170px] bg-white border rounded-lg cursor-pointer flex items-center pl-3 pr-2 ${JSON.stringify(sort) === "{}"?'!pr-2':''}`}
      ...
      <div
        ...
        className={`${dropSort
          ...
          } duration-200 absolute  shadow  rounded-lg   p-2 top-12 -right-12 md:right-0 w-[310px] h-[137px] bg-white`}
      >
